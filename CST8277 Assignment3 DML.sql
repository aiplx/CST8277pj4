...
INSERT INTO user_roles (user_id, role_id) VALUES (3, 1); -- aiplx as Producer
INSERT INTO user_roles (user_id, role_id) VALUES (3, 2); -- aiplx as Subscriber
...
-- Inserting messages by aiplx
INSERT INTO messages (content, user_id, timestamp) VALUES ('Hello from aiplx!', 3, '2023-03-03');
INSERT INTO messages (content, user_id, timestamp) VALUES ('Thank you for joining us.', 3, '2023-04-03');

-- Inserting subscriptions where Biden subscribe to aiplx & Aiden and aiplx subscribe to Aiden
